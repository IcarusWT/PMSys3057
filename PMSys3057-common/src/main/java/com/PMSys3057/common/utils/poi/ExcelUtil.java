package com.PMSys3057.common.utils.poi;
...
import com.PMSys3057.common.reflect.ReflectUtils;
...
public class ExcelUtil<T>
{
    ...
    public static final int sheetSize = 65536;          // Excel sheet最大行数，默认65536
    private String sheetName;                           // 工作表名称
    private Excel.Type type;                            // 导出类型（EXPORT:导出数据；IMPORT：导入模板）
    private Workbook wb;                                // 工作薄对象
    private Sheet sheet;                                // 工作表对象
    private List<T> list;                               // 导入导出数据列表
    private List<Field> fields;                         // 注解列表
    public Class<T> clazz;                              // 实体对象
